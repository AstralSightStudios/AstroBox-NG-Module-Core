...
此项目为AstroBox协议核心，用于为穿戴设备提供协议通信功能，此库使用 AGPL 3.0 授权

This project is the core of the AstroBox protocol, used to provide protocol communication capabilities for wearable devices. This library is licensed under AGPL 3.0.
